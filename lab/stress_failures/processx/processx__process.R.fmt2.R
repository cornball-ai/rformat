...
#'   It is only run once.
        ...
        initialize = function (command = NULL, args = character(),
                               ...
                               cleanup_tree = FALSE, wd = NULL,
                               echo_cmd = FALSE, supervise = FALSE,
                               windows_verbatim_args = FALSE,
                               windows_hide_window = FALSE,
                               windows_detached_process = !cleanup,
                               encoding = "", post_process = NULL) process_initialize(
                                   self, private, command, args, stdin, stdout,
                                   stderr, pty, pty_options, connections,
...
#' already finished/dead when `processx` tried to terminate it).
        ...
        kill = function (grace = 0.1, close_connections = TRUE) process_kill(
            self, private, grace, close_connections),
...
#' `"notepad.exe"`, `"Rterm.exe"`, etc.).
        ...
        kill_tree = function (grace = 0.1, close_connections = TRUE) process_kill_tree(
            self, private, grace, close_connections),
...
#' throw an error.
        ...
        read_output_lines = function (n = -1) process_read_output_lines(self,
            private, n),
...
#' it reads from the standard error stream.
        ...
        read_error_lines = function (n = -1) process_read_error_lines(self,
            private, n),
...
#' process exited). It return `TRUE` otherwise.
        ...
        is_incomplete_output = function () process_is_incompelete_output(self,
            private),
...
#' process exited). It return `TRUE` otherwise.
        ...
        is_incomplete_error = function () process_is_incompelete_error(self,
            private),
...
#' `FALSE` otherwise.
        ...
        has_input_connection = function () process_has_input_connection(self,
            private),
...
#' `FALSE` otherwise.
        ...
        has_output_connection = function () process_has_output_connection(self,
            private),
...
#' `FALSE` otherwise.
        ...
        has_error_connection = function () process_has_error_connection(self,
            private),
...
#' `FALSE` otherwise.
        ...
        has_poll_connection = function () process_has_poll_connection(self,
            private),
...
#' standard input stream of the process.
        ...
        get_input_connection = function () process_get_input_connection(self,
            private),
...
#' standard output stream of the process.
        ...
        get_output_connection = function () process_get_output_connection(self,
            private),
...
#' standard error stream of the process.
        ...
        get_error_connection = function () process_get_error_connection(self,
            private),
...
#' `stdout="|"` was used. Otherwise, it will throw an error.
        ...
        read_all_output_lines = function () process_read_all_output_lines(self,
            private),
...
#' `stderr="|"` was used. Otherwise, it will throw an error.
        ...
        read_all_error_lines = function () process_read_all_error_lines(self,
            private),
...
#' one.
        ...
        get_poll_connection = function () process_get_poll_connection(self,
            private),
...
process_wait <- function (self, private, timeout) {
    ...
    chain_clean_call(c_processx_wait, private$status, as.integer(timeout),
...
process_kill_tree <- function (self, private, grace, close_connections) {
    ...
    if (!ps::ps_is_supported()) {
        throw(new_not_implemented_error("kill_tree is not supported on this platform"))
    }
...
default_pty_options <- function () {
    list(echo = FALSE, rows = 25L, cols = 80L)
}
